...
import { CONTENT } from '@/data/industries/automotive-fleet'

/**
 * Automotive & Fleet — Figma 6246:1390, the industry detail frame.
 *
 ...
 * lives in src/data/industries/automotive-fleet.ts; `layout` carries the one
...
export default function Page() {
  return <ServiceDetailPage content={CONTENT} layout={{ intro: 811, accept: 981, certifications: 346, faq: 729 }} />
}
