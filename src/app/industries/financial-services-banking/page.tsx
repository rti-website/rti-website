...
/**
 * Financial Services & Banking — Figma 6246:1390, the industry detail frame.
 *
 ...
 * lives in src/data/industries/financial-services-banking.ts; `layout` carries the one
...
export default function Page() {
  return <ServiceDetailPage content={CONTENT} layout={{ intro: 802, accept: 873, certifications: 346, faq: 729 }} />
}
