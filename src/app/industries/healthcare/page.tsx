...
import { CONTENT } from '@/data/industries/healthcare'

/**
 * Healthcare — Figma 6246:1390, the industry detail frame.
 *
 ...
 * lives in src/data/industries/healthcare.ts; `layout` carries the one
...
export default function Page() {
  return <ServiceDetailPage content={CONTENT} layout={{ intro: 757, accept: 885, certifications: 346, faq: 729 }} />
}
