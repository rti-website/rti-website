...
/**
 * light-bulbs/Minnesota: a landing page for Google Ads only (Asim, 24 Sep 2026).
 ...
 */
const PAGE = STATE_PAGES['light-bulbs'].Minnesota
...
export default function Page() {
  return <ServiceDetailPage content={PAGE.content} layout={{ intro: 781, process: 728 }} />
}
