...
export const GLYPHS = {
  ...
  /**
   * Opening hours — a dial with the hands at ten past ten. Drawn 22 Sep 2026
   * for the location pages' hours rows (Figma 6744:8818 and 6744:2480 draw a
   * clock the same weight as the pin and phone above). Same 16-grid, same
   * 1.4 stroke read as a fill, so the four sit as one set.
   */
  clock: 'M8 1.3a6.7 6.7 0 1 0 0 13.4A6.7 6.7 0 0 0 8 1.3Zm0 1.5a5.2 5.2 0 1 1 0 10.4A5.2 5.2 0 0 1 8 2.8Zm-.7 2.1h1.4v3.3l2.3 1.4-.7 1.2-3-1.8V4.9Z',
} as const
