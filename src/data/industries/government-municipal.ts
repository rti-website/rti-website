...
export const CONTENT = industryPage({
  ...
  todo: ['The doc gives four FAQs where the other industry pages have five — an empty bold line sits where a fifth question was drafted. Musaveer to supply it or confirm four is intended.'],
})
